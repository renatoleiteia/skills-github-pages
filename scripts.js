...
window.ACELERO_IDIOMAS = {
  ...
  en: {
    ...
    'hero.kpi.1': 'continents covered',
    'hero.kpi.v2': 'China → Europe → Brazil',
    'hero.kpi.2': 'the corridor we run most',
    'hero.kpi.3': 'QC stages before shipment',
    'hero.kpi.4': 'suppliers approved without validation',
    'hero.role.1': 'Scroll',

    /* seções — numeração */
    'hdnum.1': '01 — About', 'hdnum.2': '02 — Services', 'hdnum.3': '03 — Process',
    'hdnum.4': '04 — Operating standard', 'hdnum.6': '06 — Why we do it',
    ...
    /* resultados */
    'res.h.l1': 'Not a promise.',
    'res.h.l2': 'It is the <em>standard of</em>',
    'res.h.l3': '<em>every operation.</em>',
    'num.1': 'Continents covered: Asia, Europe and the Americas',
    'num.2': 'Open costing: you see every line of the bill before approving',
    'num.3': 'Quality-control stages before shipment',
    'num.4': 'Point of contact, from the first quote to delivery',
    'num.v5': 'China → Europe → Brazil',
    'num.5': 'The corridor we run most, end to end',
    'num.6': 'Suppliers approved without document and capacity validation',
    'res.nota.1': 'Every line above is an operating commitment, not a marketing metric. In the diagnostic meeting we show where each of them shows up in your process — with a name, a deadline and an owner.',
    ...
    'faq.a.5': 'It is part of the operation and no cause for panic. Our paperwork is checked before arrival precisely to reduce that chance — and when it happens, the customs team takes over the dialogue with the authorities and the terminal the same day. You do not find out from the terminal: the channel change reaches you together with the new deadline and the next step.',
  ...
  es: {
    ...
    'hero.kpi.1': 'continentes atendidos',
    'hero.kpi.v2': 'China → Europa → Brasil',
    'hero.kpi.2': 'el corredor que más operamos',
    'hero.kpi.3': 'etapas de QC antes del embarque',
    'hero.kpi.4': 'proveedor aprobado sin validación',
    'hero.role.1': 'Baje',

    /* secciones — numeración */
    'hdnum.1': '01 — Nosotros', 'hdnum.2': '02 — Servicios', 'hdnum.3': '03 — Proceso',
    'hdnum.4': '04 — Estándar de operación', 'hdnum.6': '06 — Por qué lo hacemos',
    ...
    /* resultados */
    'res.h.l1': 'No es promesa.',
    'res.h.l2': 'Es el <em>estándar de</em>',
    'res.h.l3': '<em>toda operación.</em>',
    'num.1': 'Continentes atendidos: Asia, Europa y América',
    'num.2': 'Costo abierto: usted ve cada ítem de la cuenta antes de aprobar',
    'num.3': 'Etapas de control de calidad antes del embarque',
    'num.4': 'Punto de contacto, del primer presupuesto a la entrega',
    'num.v5': 'China → Europa → Brasil',
    'num.5': 'El corredor que más operamos, de punta a punta',
    'num.6': 'Proveedor aprobado sin validación documental y de capacidad',
    'res.nota.1': 'Cada línea de arriba es un compromiso de operación, no un indicador de marketing. En la reunión de diagnóstico mostramos dónde aparece cada uno en su proceso — con nombre, plazo y responsable.',
    ...
    'faq.a.5': 'Es parte de la operación y no es motivo de pánico. Nuestra documentación se revisa antes del arribo justamente para reducir esa probabilidad — y, cuando ocurre, el equipo de aduana asume la interlocución con la autoridad y con la terminal el mismo día. Usted no se entera por la terminal: el cambio de canal le llega junto con el plazo nuevo y el próximo paso.',
